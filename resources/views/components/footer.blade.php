    <footer class="d-flex justify-content-between py-3 align-items-center" style="background-color: #dac88e;">
        ...
        <ul class="nav justify-content-end list-unstyled d-flex mx-3">
            <li class="ms-3">
                <a class="text-muted" href="https://es-la.facebook.com/" target="_blank">
            ...
            <li class="ms-3">
                <a class="text-muted" href="https://www.youtube.com/" target="_blank">
            ...
            <li class="ms-3">
                <a class="text-muted" href="https://web.telegram.org/" target="_blank">
