...
<x-navbar>
    <div class="container">
        <form class="shadow-lg p-3 my-5 rounded" action="{{ route('profesor.updateMiPerfil', $user) }}" method="POST" style="background-color: #e5d9b0;" enctype="multipart/form-data" novalidate>
            @method('PATCH')
            @csrf
            <div class="row mt-3">
                <div class="col-lg-6">
