...
<x-navbar>
    <div class="container">
        <form class="shadow-lg p-3 my-5 rounded create_profesor" action="{{ route('profesor.storeMateria', $profesor) }}" method="POST" style="background-color: #e5d9b0;" novalidate>
            @csrf
